...
####===================================================================BUTTON_ALGORITHMS====================================================####
        ...
        def SearchTrade():##SHOW rows from User Database of Trades
            ...
            if(len(Stock.get())!=0) or (len(Play.get())!=0) or (len(Date.get())!=0):##SHOW only specified stock/play/date
                for row in self.tree.get_children():
                    self.tree.delete(row)
                i=0
...
####============================================================TREEVIEW======================================================####
        ...
        self.tree.column("STOCK",anchor=CENTER,stretch=NO,width=155)
        ...
        self.tree.column("RISK",anchor=CENTER,stretch=NO,width=155)
        ...
        self.tree.column("OUTCOME",anchor=CENTER,stretch=NO,width=157)
...
#1.1 Update
    #Optimization. Added scrollbar widget. Laptops no longer require mouse to navigate trade records.
    #Optimization. Removed temp, os module. (No longer intending to use these modules on future versions.)
    #Optimization. Search by date no longer require additional input like stock name or play.
    #Bug Fix. Middle mouse button now scrolls the Treeview up and down as intended.
    #Bug Fix. Factory Reset now includes setting saved ('pickled') variable to default.
